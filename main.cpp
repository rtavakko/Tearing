...
//With as few as 2 display windows and VSync turned on, a clear lag is visible; the actual calculated FPS of each
//display window seems ok but it seems the GUI thread blocks to accomodate sync

#define OPENGL_MAJOR_VERSION 4
#define OPENGL_MINOR_VERSION 1
#define OPENGL_SWAP_INTERVAL 0
#define OPENGL_SWAP_BEHAVIOUR 0
#define OPENGL_NUM_DISPLAY_WINDOWS 2
